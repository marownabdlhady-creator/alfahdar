...
export const metadata: Metadata = {
  ...
  description:
    "معرض أعمال الفهدار: نماذج من مشاريعنا في المقاولات والبناء، التشطيبات، الأعمال الفنية، الصيانة وتوريد المواد في السعودية.",
  keywords: [
    "أعمال الفهدار",
    "مشاريع مقاولات",
    "معرض تشطيبات",
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-10">
        <Reveal className="min-w-0">
          ...
          <p className="mt-4 max-w-[52ch] text-step-0 text-muted">
            نماذج من مشاريعنا في المقاولات، التشطيبات، الصيانة والخدمات الفنية.
          </p>
        </Reveal>
