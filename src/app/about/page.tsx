...
export const metadata: Metadata = {
  ...
  description:
    "من نحن — الفهدار شركة سعودية تقدّم حلولاً متكاملة في المقاولات والبناء، التشطيبات، الأعمال الفنية، الصيانة، توريد المواد والنظافة في المملكة العربية السعودية، بجودة واحترافية وفريق مختص لكل تخصص.",
  keywords: [
    "من نحن",
    "الفهدار",
    "شركة مقاولات",
  ...
  openGraph: {
    ...
    title: "من نحن | الفهدار",
    description:
      "الفهدار شركة سعودية تجمع المقاولات والتشطيبات والصيانة والخدمات الفنية والنظافة تحت سقف واحد، بجودة والتزام ووضوح في كل مرحلة.",
...
export default function AboutPage() {
  const organizationSchema = {
    ...
    url: absoluteUrl("/"),
    description:
      "شركة سعودية تقدّم حلولاً متكاملة في المقاولات والبناء، التشطيبات، الأعمال الفنية، الصيانة، توريد المواد والنظافة.",
        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-10">
          <Reveal className="min-w-0">
            ...
            <p className="mt-6 max-w-[62ch] text-step-1 leading-relaxed text-ink">
              ...
              المقاولات والبناء، التشطيبات، الأعمال الفنية، الصيانة، توريد
              المواد وخدمات النظافة. نعمل بفرق مختصة لكل مجال، ونلتزم بالجودة
